...
From Figma.
@https://www.figma.com/design/j988wCsA6vPxFB47frbaU7/Inspiraci%C3%B3n-Branding?node-id=1-1362&m=dev
...
- Component installed/created in `/components/ui/`
...
- **Use shadcn MCP via context7 MCP** to search, view, and get examples before building
